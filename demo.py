...
class VariantionalAutoencoder(object):
    ...
    def build(self):
        ...
        self.latent_loss = tf.reduce_mean(-tf.reduce_sum(self.x_hat * tf.log(self.x_hat), axis=1))

        self.total_loss = tf.reduce_mean(recon_loss + self.latent_loss)
...
def trainer(learning_rate=1e-2, batch_size=100, num_epoch=75, n_z=10):
